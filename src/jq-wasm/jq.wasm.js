console.log('load jqwasm')
const newJQ = (function() {
...
{  module.exports = newJQ; console.log('1'); }
else if (typeof define === 'function' && define['amd'])
{  define([], function() { return newJQ; }); console.log('2') }
else if (typeof exports === 'object')
{  exports["newJQ"] = newJQ; console.log('3') }
